        ...
        <div className="flex bg-gray-200 p-1 rounded-lg">
          <button
            ...
            className={`w-1/2 py-2 text-sm font-medium rounded-md transition-all ${
              role === 'CUSTOMER' ? 'bg-blue-600 text-white shadow' : 'text-gray-700 hover:text-gray-950'
            }`}
          ...
          <button
            type="button"
            className={`w-1/2 py-2 text-sm font-medium rounded-md transition-all ${
              role === 'DEALER' ? 'bg-blue-600 text-white shadow' : 'text-gray-700 hover:text-gray-950'
            }`}
